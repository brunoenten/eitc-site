import logo from '@/images/clients/wintr/logo.svg'
import imageAdrienNaeem from '@/images/clients/wintr/adrien-naeem.jpeg'

export const caseStudy = {
  client: 'Wintr',
  title: 'Wintr, ski rental and delivery',
  description:
    'Wintr was a startup whose ambition was to deliver rental skis to their customers residences',
  summary: [

...
export const caseStudy = {
  client: 'Agenda.ch',
  title: 'Professional agenda & Billing booking system',
  description:
    'agenda.ch is a Swiss online application for professionals that allows them to manage their planning and includes a billing system.',
  summary: [
    'agenda.ch is a Swiss online application for professionals that allows them to manage their planning and includes a billing system.',
